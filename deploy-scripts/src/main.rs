...
async fn main() -> Result<(), Error> {
    ...
    let init_method_name: &str = "init_multi_sig"; // Example
    ...
    use multi_sig::MyInputType; // Example
    ...
    let update_payload = transactions::UpdateContractPayload {
        ...
        receive_name: OwnedReceiveName::new_unchecked("multi_sig.receive".to_string()),
